...
public class DuplicateIMMMethodVisitor extends MethodVisitor {
    ...
    private static boolean CLONE_METHOD = true; // debug flag
    ...
    public DuplicateIMMMethodVisitor(int api, MethodVisitor mv, String className, String methodName, int targetMethodLOC, String desc, int access, MethodVisitor newMethodVisitor, boolean firstVisit, String IMMFlagClass) {
        super(api, mv);
        ...
        System.out.println(">> In Method Visitor for " + className + ", " + methodName + desc + ". ID: " + this.targetMethodLOC);
    }
    ...
    public void insertFlagGuard() {
        ...
        mv.visitFieldInsn(Opcodes.GETSTATIC, IMMFlagClass.isEmpty() ? className : IMMFlagClass, IMMFlagName + "_" + this.targetMethodLOC, "Z");
        ...
        if (isStatic) {
            ...
            mv.visitMethodInsn(Opcodes.INVOKEINTERFACE, className, IMMMethodName + "_" + this.targetMethodLOC, desc, true);
        } else {
...
//                mv.visitInsn(Opcodes.DUP);
                ...
                mv.visitFieldInsn(Opcodes.PUTSTATIC, IMMFlagClass.isEmpty() ? className : IMMFlagClass, IMMFlagName + "_" + this.targetMethodLOC, "Z");
            }
